...
namespace fill {
    ...
    void    begin_end() {
        ...
        set_type::iterator                  vib = m.begin();
        set_type::iterator                  vie = m.end();
        set_type::const_iterator            cib = m.begin();
        set_type::const_iterator            cie = m.end();
        set_type::reverse_iterator          vrb = m.rbegin();
        set_type::reverse_iterator          vre = m.rend();
        set_type::const_reverse_iterator    crb = m.rbegin();
        set_type::const_reverse_iterator    cre = m.rend();
        DSOUT() << *vib << std::endl;
        DSOUT() << *cib << std::endl;
        DSOUT() << *vrb << std::endl;
        DSOUT() << *crb << std::endl;
...
namespace logic {
    ...
    void    set_on_set() {
        ...
        for (set_type::const_reverse_iterator it = s.rbegin(); it != s.rend(); ++it) {
            DSOUT() << *it << std::endl;
        }
    }
