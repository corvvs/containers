...
int main()
{
    ...
    // DSOUT() << m.empty() << std::endl;
    // DSOUT() << m.size() << std::endl;
    // DSOUT() << m.max_size() << std::endl;
    // m.insert(NS::make_pair("hello", 42));
    // DSOUT() << (m.begin() == m.end()) << std::endl;
    // DSOUT() << m.empty() << std::endl;
    // DSOUT() << m.size() << std::endl;
    // DSOUT() << m.max_size() << std::endl;
    // iterator        vit = m.begin();
    // DSOUT() << vit->first << ", " << vit->second << std::endl;
    // const_iterator    cit = m.begin();
    // DSOUT() << cit->first << ", " << cit->second << std::endl;

    // DSOUT() << (vit == cit) << std::endl;
    // DSOUT() << (cit == vit) << std::endl;
    // DSOUT() << m.count("hello") << std::endl;
    // DSOUT() << m.count("world") << std::endl;
    // vit = m.find("hello");

    // m.insert(NS::make_pair("world", 21));
    // PairClass<iterator, iterator> range = m.equal_range("hello");
    // DSOUT() << (range.first == range.second) << std::endl;
    // DSOUT() << range.first->first << " - " << range.second->first << std::endl;
    // range = m.equal_range("oni");
    // DSOUT() << (range.first == range.second) << std::endl;
    // PairClass<const_iterator, const_iterator> crange = m.equal_range("hello");
    // DSOUT() << (crange.first == crange.second) << std::endl;

    // vit = m.lower_bound("hello");
    // DSOUT() << vit->first << ", " << vit->second << std::endl;
    // vit = m.lower_bound("a");
    // DSOUT() << vit->first << ", " << vit->second << std::endl;

    // vit = m.upper_bound("hello");
    // DSOUT() << vit->first << ", " << vit->second << std::endl;
    // vit = m.upper_bound("a");
    // DSOUT() << vit->first << ", " << vit->second << std::endl;

    // m["gohan"];
    // DSOUT() << m.find("gohan")->second << std::endl;
    // m["gohan"] = 11111;
    // DSOUT() << m.find("gohan")->second << std::endl;
    // m["pan"] = 22222;
    // DSOUT() << m.find("pan")->first << std::endl;

    // m.erase(m.lower_bound("a"), m.lower_bound("z"));
    // DSOUT() << (m.begin() == m.end()) << std::endl;
    // DSOUT() << m.empty() << std::endl;
    // DSOUT() << m.size() << std::endl;
    // DSOUT() << m.max_size() << std::endl;
